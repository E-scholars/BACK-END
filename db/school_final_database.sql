...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2021 at 10:56 AM
...
CREATE TABLE `attendance` (
  ...
  `present` varchar(10) NOT NULL DEFAULT 'Absent',
  `form_status` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `doubt` (
  ...
  `HID` int(11) NOT NULL,
  `ques` text NOT NULL,
  `ques_file` varchar(150) DEFAULT NULL,
  `ans` text NOT NULL DEFAULT 'NOT RESOLVED',
  `ans_file` varchar(150) DEFAULT NULL,
...
CREATE TABLE `queries` (
  ...
  `ID` int(11) NOT NULL,
  `query` text NOT NULL,
  `response` text NOT NULL DEFAULT '\'\\\'NOT RESOLVED\\\'\'',
  `query_to` varchar(10) NOT NULL,
...
CREATE TABLE `student` (
  ...
  `SPASS` varchar(11) NOT NULL DEFAULT '1234'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `work_submission` (
  ...
  `CWID` int(11) NOT NULL,
  `ID` int(11) NOT NULL,
  `work_file` varchar(150) NOT NULL,
  `submission_status` varchar(20) NOT NULL DEFAULT 'NOT SUBMITTED',
...
--
ALTER TABLE `admission`
  MODIFY `ADID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT for table `attendance`
--
ALTER TABLE `attendance`
  MODIFY `ATID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `class_work`
--
ALTER TABLE `class_work`
  MODIFY `CWID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `new_staff`
  MODIFY `NSID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `queries`
  MODIFY `query_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `salary`
--
ALTER TABLE `salary`
  MODIFY `SALID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `student`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10269;
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`HID`) REFERENCES `hclass` (`HID`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `class_work`
--
ALTER TABLE `class_work`
  ADD CONSTRAINT `class_work_ibfk_1` FOREIGN KEY (`HID`) REFERENCES `hclass` (`HID`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `doubt`
--
ALTER TABLE `doubt`
  ADD CONSTRAINT `doubt_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `student` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `doubt_ibfk_2` FOREIGN KEY (`HID`) REFERENCES `hclass` (`HID`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `hclass`
--
ALTER TABLE `hclass`
  ADD CONSTRAINT `hclass_ibfk_1` FOREIGN KEY (`TID`) REFERENCES `staff` (`TID`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `salary`
  ADD CONSTRAINT `salary_ibfk_1` FOREIGN KEY (`TID`) REFERENCES `staff` (`TID`) ON UPDATE CASCADE;

--
-- Constraints for table `work_submission`
--
ALTER TABLE `work_submission`
  ADD CONSTRAINT `work_submission_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `student` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `work_submission_ibfk_2` FOREIGN KEY (`CWID`) REFERENCES `class_work` (`CWID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
