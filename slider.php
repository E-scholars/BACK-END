<div>
	...
	<body style="height:100%; margin-bottom:0;" >
		...
		<div class="onslider"style="transform: translate(+350%, +20%);">
				<a href="admin_login.php"style="width:45%;height: 36px;display:inline-block;">
					<button class="proceed">Login</button>
				</a>
				<a href="enroll.php"style="width:45%;height: 36px;display:inline-block;">
					<button class="proceed">Enroll</button>
				</a>			
		</div>
