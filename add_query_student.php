			...
			<div id="section">
				...
				<?php
						...
						{   
							...
							$sq="insert into queries(ID,query_to,query,role) values({$_SESSION["ID"]},'{$_POST["query_to"]}','{$_POST["query"]}','student')";
				...
				<?php
						...
						{   
							...
							$sql="select * from queries where query_to='{$_POST["query_to"]}' and ID={$_SESSION["ID"]} and role='student'";
							$re=$db->query($sql);
							if($re->num_rows>0)
							{
								echo '
