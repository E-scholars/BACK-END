			...
			<div id="section">
				...
				<div class="content">
					...
					<?php
						if(isset($_POST["submit"]))
						{
							...
							{
								$sq="insert into student(ID,NAME,FNAME,DOB,GEN,PHO,MAIL,ADDR,SCLASS,SSEC,SIMG) values('{$_POST["id"]}','{$_POST["name"]}','{$_POST["fname"]}','{$edate}','{$_POST["gen"]}','{$_POST["pho"]}','{$_POST["email"]}','{$_POST["addr"]}','{$_POST["cla"]}','{$_POST["sec"]}','{$target_file}')";
				...
				<div class="lbox">
					<label> ID</label><br>
						...
						?>
					<input type="number" class="input3" name="id" style="background:#b1b1b1;" value="<?php echo $no;?>" readonly  ><br><br>
